...
contract GmxTimelock is IGmxTimelock {
    ...
    function setMaxLeverage(
        ...
        require(
            ...
            "GmxTimelock: invalid _maxLeverage"
        );
    ...
    function setFundingRate(
        ...
        require(
            ...
            "GmxTimelock: invalid _fundingRateFactor"
        );
        require(
            _stableFundingRateFactor < MAX_FUNDING_RATE_FACTOR,
            "GmxTimelock: invalid _stableFundingRateFactor"
        );
    ...
    function setFees(
        ...
        require(
            ...
            "GmxTimelock: invalid _taxBasisPoints"
        );
        require(
            _stableTaxBasisPoints < MAX_FEE_BASIS_POINTS,
            "GmxTimelock: invalid _stableTaxBasisPoints"
        );
        require(
            _mintBurnFeeBasisPoints < MAX_FEE_BASIS_POINTS,
            "GmxTimelock: invalid _mintBurnFeeBasisPoints"
        );
        require(
            _swapFeeBasisPoints < MAX_FEE_BASIS_POINTS,
            "GmxTimelock: invalid _swapFeeBasisPoints"
        );
        require(
            _stableSwapFeeBasisPoints < MAX_FEE_BASIS_POINTS,
            "GmxTimelock: invalid _stableSwapFeeBasisPoints"
        );
        require(
            _marginFeeBasisPoints < MAX_FEE_BASIS_POINTS,
            "GmxTimelock: invalid _marginFeeBasisPoints"
        );
        require(
            _liquidationFeeUsd < 10 * PRICE_PRECISION,
            "GmxTimelock: invalid _liquidationFeeUsd"
        );
    ...
    function setTokenConfig(
        ...
        require(
            ...
            "GmxTimelock: token not yet whitelisted"
        );
    ...
    function setInPrivateTransferMode(
        ...
        if (excludedTokens[_token]) {
            ...
            require(
                ...
                "GmxTimelock: invalid _inPrivateTransferMode"
            );
        }
    ...
    function _mint(address _token, address _receiver, uint256 _amount) private {
        ...
        require(
            ...
            "GmxTimelock: maxTokenSupply exceeded"
        );
    }
    ...
    function _validateAction(bytes32 _action) private view {
        require(
            ...
            "GmxTimelock: action not signalled"
        );
        require(
            pendingActions[_action] < block.timestamp,
            "GmxTimelock: action time not yet passed"
        );
    }
